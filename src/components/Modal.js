...
export default class Modal extends Component {
  ...
  render() {
    ...
    return h(RModal, {
      ...
      title && h.div({ style: { display: 'flex', alignItems: 'baseline', marginBottom: '1rem' } }, [
        h.div({ style: { fontSize: 18, fontWeight: 'bold', color: colors.darkBlue[0] } }, [title]),
        titleExtras,
        showX && h(Clickable, {
      ...
      children,
      showButtons && h.div({ style: styles.buttonRow }, [
        showCancel ?
          buttonSecondary({
