...
export const textInput = function(props) {
  return h.h(Interactive, _.merge(
    {
      as: 'input',
...
export const validatedInput = props => {
  ...
  return h.h(Fragment, [
    ...
    error && h.div({ style: styles.validationError }, [error])
  ])
}
  ...
  render() {
    ...
    return h.h(Autosuggest, {
      ...
      renderSuggestionsContainer: ({ containerProps, children }) => {
        return h.div({ ref: this.containerRef }, [
          children && h.h(AutocompleteSuggestions, { containerProps, children, containerRef: this.containerRef })
        ])
      },
