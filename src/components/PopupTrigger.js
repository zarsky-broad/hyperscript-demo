...
export const InfoBox = ({ size, children, style, side }) => h.h(PopupTrigger, {
  side,
  content: h.div({ style: { padding: '0.5rem', width: 300 } }, children)
}, [
  h.span({ style: { cursor: 'pointer', color: colors.blue[0], ...style } }, [
